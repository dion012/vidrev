...
<p><?php printf( esc_html__( "Hi, we would like to inform you that the highest bid for the following auction doesn't exceed the minimum reserve price:", 'yith-auctions-for-woocommerce' ) ); ?></p>
