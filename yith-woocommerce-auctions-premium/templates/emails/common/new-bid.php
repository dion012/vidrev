...
<p>
	...
	echo wp_kses_post( sprintf( __( 'Someone made a new bid for the item “<a href="%1$s"><strong>%2$s</strong></a>”.', 'yith-auctions-for-woocommerce' ), $email->object['url_product'], $email->object['product_name'] ) );
	?>
</p>
