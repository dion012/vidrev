<?php
/**
 * Email for user when first stripe attempt fails
 *
...
<p><?php echo esc_html__( 'We had an issue processing your payment for this item:', 'yith-auctions-for-woocommerce' ); ?></p>
...
if ( 'requires_validation' === $email->object['gateway_response']['action'] ) { // Card needs validation.
	...
	<p>
		...
		echo wp_kses_post( sprintf( __( 'We don\'t want you to lose the item you have won, so we ask you to %s. We will try to charge your credit card again in the next 24hrs.', 'yith-auctions-for-woocommerce' ), $payment_link ) );
		?>
	</p>
<?php } ?>
