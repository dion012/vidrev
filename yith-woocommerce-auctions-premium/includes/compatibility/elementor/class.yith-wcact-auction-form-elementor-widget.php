...
/**
 * YITH_WCACT_Auction_Form_Elementor_Widget Class.
 *
...
class YITH_WCACT_Auction_Form_Elementor_Widget extends \Elementor\Widget_Base {
	...
	/**
	 * Register YITH_WCACT_Auction_Form_Elementor_Widget widget controls.
	 *
	...
	protected function render() {
		...
		echo is_callable( 'apply_shortcodes' ) ? apply_shortcodes( '[yith_auction_form id=' . $product_id . ']' ) : do_shortcode( '[yith_auction_form id=' . $product_id . ']' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo '</div>';
	}
}
