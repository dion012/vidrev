...
/**
 * YITH_WCACT_List_Bids_Elementor_Widget Class.
 *
...
class YITH_WCACT_List_Bids_Elementor_Widget extends \Elementor\Widget_Base {
	...
	/**
	 * Register YITH_WCACT_List_Bids_Elementor_Widget widget controls.
	 *
	...
	/**
	 * Render YITH_WCACT_List_Bids_Elementor_Widget widget output on the frontend.
	 *
	 * @since  2.0.0
	 * @access protected
	 */
	protected function render() {
		...
		echo is_callable( 'apply_shortcodes' ) ? apply_shortcodes( '[yith_auction_show_list_bid id=' . $product_id . ']' ) : do_shortcode( '[yith_auction_show_list_bid id=' . $product_id . ']' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		echo '</div>';
	}
}
