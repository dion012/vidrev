 ...
 */
class YITH_WCACT_Auction_Widget_Future extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'yith-wcact-auction-widget-future';
		$this->widget_id          = 'yith-woocommerce-auctions-future';
		$this->widget_name        = esc_html__( 'YITH Auctions Future', 'yith-auctions-for-woocommerce' );
		$this->widget_description = esc_html__( 'Display future auction products', 'yith-auctions-for-woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => '',
	...
	public function get_products( $args, $instance ) {
		 ...
		 * @return array
		 */
		return new WP_Query( apply_filters( 'yith_wcact_products_widget_query_args', $query_args, 'yith-woocommerce-auctions-future' ) );
	}
 ...
 * @since 1.0.0
 */
function yith_wcact_register_widgets_future() {
	register_widget( 'YITH_WCACT_Auction_Widget_Future' );
}
add_action( 'widgets_init', 'yith_wcact_register_widgets_future' );
