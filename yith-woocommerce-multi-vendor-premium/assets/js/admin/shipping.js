...
var YITH_Shipping = /*#__PURE__*/function () {
  ...
  _createClass(YITH_Shipping, [{
    ...
    value: function init() {
      ...
      this._initSelect(); // Ini sortable


      this._initSortable(); // Listener actions.
      ...
      this.zoneTable.on('yith-wcmv-shipping-list-updated', this.handleListUpdate.bind(this)); // Handle Zone
      ...
      this.zoneTable.on('click', '.save-zone', {
        self: this
      }, this.saveZone); // Handle Shipping Method

      this.zoneTable.on('click', '.yith-wcmv-shipping-zone-edit__method-add', {
        self: this
      }, this.addMethod);
    ...
    value: function selectRegionsActions(event) {
      ...
      var action = jQuery(this).data('action'),
          select = jQuery(this).closest('.yith-wcmv-shipping-zone-edit__field').find('.yith-wcmv-shipping-zone-region-select');
    ...
    value: function addZone(event) {
      ...
      event.preventDefault();
      event.stopImmediatePropagation();
      var template = wp.template('yith-wcmv-shipping-zones-add');
      ...
      if (this.zoneAdd.is(':visible')) {
        ...
        this._initSelect(); // At the end, show it!
    ...
    value: function editZone(event) {
      ...
      wrap.toggleClass('editing'); // Handle container class.
      ...
      wrap.find('.yith-wcmv-shipping-zone-edit').slideToggle();
    }
  }, {
    key: "deleteZone",
      ...
      ajax_request.post(data, zone).done(function (res) {
        ...
        if (res !== null && res !== void 0 && res.success && res !== null && res !== void 0 && (_res$data = res.data) !== null && _res$data !== void 0 && _res$data.html) {
          ...
          if (to_replace.length) {
            ...
            self.zoneAdd.html('').hide(); // Add zone.
    ...
    value: function addMethod(event) {
      ...
      event.stopImmediatePropagation();
      var self = event.data.self,
          template = wp.template('yith-wcmv-shipping-zones-add-method');
    ...
    value: function editMethod(event) {
      ...
      var self = event.data.self,
          ...
          template = wp.template('yith-wcmv-shipping-zones-edit-method');
      var data = JSON.parse(jQuery('#yith-wcmv-shipping-method-data-' + method_id).val()); // Add keys to data.
    ...
    value: function deleteMethod(event) {
      event.preventDefault();
      event.stopImmediatePropagation();
      var method = jQuery(this).closest('.yith-wcmv-shipping-zone-edit__method'),
          trigger = jQuery(this).parent(),
          method_id = trigger.attr('data-method_id'),
    ...
    value: function modalSubmit(event) {
      ...
      ajax_request.post(data, jQuery('.yith-plugin-fw__modal__main')).done(function (res) {
        ...
        if (res !== null && res !== void 0 && res.success && res !== null && res !== void 0 && (_res$data3 = res.data) !== null && _res$data3 !== void 0 && _res$data3.html) {
          ...
          var method = zone.find('.yith-wcmv-shipping-zone-edit__method[data-method_id="' + (res === null || res === void 0 ? void 0 : (_res$data5 = res.data) === null || _res$data5 === void 0 ? void 0 : _res$data5.method_id) + '"]');

          if (method.length) {
            method.replaceWith(res.data.html);
          } else {
            zone.find('.yith-wcmv-shipping-zone-edit__methods ul').prepend(res.data.html);
          } // Close modal
