...
if ( ! class_exists( 'YITH_Report_Commissions_By_Vendor' ) ) {
	...
	class YITH_Report_Commissions_By_Vendor extends WC_Admin_Report {
		...
		public function vendors_widget() {
			...
			?>
			<h4 class="section_title"><span><?php esc_html_e( 'Search Vendors', 'yith-woocommerce-product-vendors' ); ?></span>
			</h4>
			<div class="section">
				<form method="GET">
					<div>
			...
			<h4 class="section_title"><span><?php esc_html_e( 'Top Sellers', 'yith-woocommerce-product-vendors' ); ?></span>
			</h4>
			<div class="section">
				<table cellspacing="0">
					<?php
			...
			<h4 class="section_title"><span><?php esc_html_e( 'Top Earners', 'yith-woocommerce-product-vendors' ); ?></span>
			</h4>
			<div class="section">
				<table cellspacing="0">
					<?php
		...
		public function prepare_report_data() {
			...
			foreach ( $vendors as $vendor ) {
				...
				foreach ( $commission_ids as $commision_id ) {
					...
					if ( ! $commission || ! $commission->exists() || in_array( $commission->get_status(), $not_allowed_status, true ) ) {
						continue;
					}
