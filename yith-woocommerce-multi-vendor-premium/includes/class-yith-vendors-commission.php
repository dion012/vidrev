...
if ( ! class_exists( 'YITH_Vendors_Commission' ) ) {
	...
	class YITH_Vendors_Commission extends YITH_Vendors_Commission_Legacy {
		...
		public function get_order_id() {
			return absint( $this->get_data( 'order_id' ) );
		}
		...
		public function get_line_item_id() {
			return absint( $this->get_data( 'line_item_id' ) );
		}
		...
		public function get_line_total() {
			return (float) $this->get_data( 'line_total' );
		}
		...
		public function get_product_id() {
			return (int) $this->get_data( 'product_id' );
		}
		...
		public function get_vendor_id() {
			return absint( $this->get_data( 'vendor_id' ) );
		}
		...
		public function get_user_id() {
			return absint( $this->get_data( 'user_id' ) );
		}
		...
		public function get_status( $context = '' ) {
			...
			if ( 'display' === $context ) {
				$all_status = YITH_Vendors()->commissions->get_status( true );
		...
		public function get_rate( $context = '' ) {
			...
			return 'display' === $context ? sprintf( '%d%%', $rate * 100 ) : $rate;
		}
