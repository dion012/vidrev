...
if ( ! class_exists( 'YITH_Vendors_Shortcodes' ) ) {
	...
	class YITH_Vendors_Shortcodes {
		...
		public static function vendors_list( $sc_args = array() ) {
			...
			$vendors = yith_wcmv_get_vendors( apply_filters( 'yith_wcmv_vendor_list_shortcode_args', $vendors_args ) );

			$total       = wp_count_terms( YITH_Vendors_Taxonomy::TAXONOMY_NAME, array( 'hide_empty' => 'true' === $sc_args['hide_no_products_vendor'] ) );
