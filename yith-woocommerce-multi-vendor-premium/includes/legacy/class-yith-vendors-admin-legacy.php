<?php
/**
 * Legacy class for YITH Vendors Admin. This class includes all deprecated methods and arguments that are going to be removed on future release.
 *
 * @since      4.0.0
 * @author     YITH
...
if ( ! class_exists( 'YITH_Vendors_Admin_Legacy' ) ) {
	 ...
	 *
	 * @class      YITH_Vendors_Admin_Legacy
	 * @since      4.0.0
	 * @author     YITH
	 * @package    YITH WooCommerce Multi Vendor
	 */
	abstract class YITH_Vendors_Admin_Legacy {
		...
		public static function vendor_count_posts( $counts, $type, $perm ) {
			...
			if ( ! $vendor || ! $vendor->is_valid() || ! in_array( $type, array( 'product', 'shop_order' ), true ) || current_user_can( 'manage_woocommerce' ) || ! $vendor->is_user_admin() ) {
