			...
			foreach ( self::$notices as $type => $notices ) {
				...
				foreach ( $notices as $notice ) {
					...
					<div class="yith-wcmv-admin-notice notice-<?php echo esc_attr( $type ); ?>">
						...
						<button type="button" class="notice-dismiss"><span class="screen-reader-text"><?php echo esc_html__( 'Dismiss this notice.', 'yith-woocommerce-product-vendors' ); ?></span></button>
					</div>
					<?php
				}
			}
