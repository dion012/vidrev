...
return apply_filters(
	...
	array(
		...
		'commissions-settings' => array(
			...
			array(
				'title'     => _x( 'Pay commissions to vendors during checkout', '[Admin] Option name', 'yith-woocommerce-product-vendors' ),
				'id'        => 'yith_wcmv_checkout_commissions_payment',
				'desc'      => _x( 'Enable this option to pay commissions to vendors during the checkout process.', '[Admin] Option description', 'yith-woocommerce-product-vendors' ),
				'type'      => 'yith-field',
				'yith-type' => 'onoff',
				'default'   => 'yes',
			),
			...
			array(
				'title'       => _x( 'Gateway to use on checkout', '[Admin] Option name', 'yith-woocommerce-product-vendors' ),
				'id'          => 'yith_wcmv_checkout_gateway',
				'desc'        => sprintf(
					// translators: %s is the link to the settings gateways section.
					_x( 'Select the gateway to use on checkout. Check all the available gateways <a href="%s" target="_blank">here</a>', '[Admin] Option description', 'yith-woocommerce-product-vendors' ),
