...
= 1.18.0 - Released on 10 August 2022 =

* New: support for WooCommerce 6.8
* Update: YITH plugin framework
* Fix: fixed overflow email on billing and shipping section
* Fix: fixed double save button for vendors

= 1.17.1 - Released on 21 July 2022 =

* Fix: orders list issue with YITH WooCommerce Multi Vendor 4.0.0

= 1.17.0 - Released on 12 July 2022 =

* New: support for WooCommerce 6.7
* Update: YITH plugin framework

= 1.16.0 - Released on 15 June 2022 =

* New: support for WooCommerce 6.6
* Update: YITH plugin framework

= 1.15.2 - Released on 11 May 2022 =

* Fix: allow vendors to see all orders

= 1.15.1 - Released on 11 May 2022 =

* Fix: duplicate product for variable product type

= 1.15.0 - Released on 10 May 2022 =

* New: support for WooCommerce 6.5
* New: support for WordPress 6.0
* New: duplicate products
* Update: YITH plugin framework
* Tweak: change the order search method. Use the new function wc_search_orders()
* Fix: vendor orders not showing up in vendor view
* Fix: style issue on pagination

= 1.14.0 - Released on 04 April 2022 =

* New: support for WooCommerce 6.4
* Update: YITH plugin framework
* Fix: several style issues with the commissions table style

= 1.13.1 - Released on 11 March 2022 =

* Fix: several style issues with the skin1 style

= 1.13.0 - Released on 03 March 2022 =

* New: support for WooCommerce 6.3
* Update: YITH plugin framework

= 1.12.1 - Released on 23 February 2022 =

* Tweak: support for YITH WooCommerce Order & Shipment Tracking 2.0

= 1.12.0 - Released on 14 February 2022 =

* New: support for WooCommerce 6.2
* Update: YITH plugin framework
* Dev: section start hook yith_wcfm_inline_actions_start
* Dev: section end hook yith_wcfm_inline_actions_end

= 1.11.0 - Released on 12 January 2022 =

* New: support for WooCommerce 6.1
* New: support for WordPress 5.9
* Update: YITH plugin framework

= 1.10.0 - Released on 15 December 2021 =

* New: support for WooCommerce 6.0
* Tweak: increase performance during products search in coupon section
* Update: YITH plugin framework
...
= 1.8.1 - Released on 14 October 2021 =

* New: "add new" button on products section

= 1.8.0 - Released on 14 October 2021 =

* New: support for WooCommerce 5.8
* Update: YITH plugin framework

= 1.7.0 - Released on 28 September 2021 =

* New: support for WooCommerce 5.7
* Update: YITH plugin framework
* Fix: shop manager see only their media files
* Fix: debug info feature removed for all logged in users

= 1.6.25 - Released on 25 August 2021 =

* New: support for WooCommerce 5.6
* Update: YITH plugin framework
* Fix: order tracking data not saved by vendor side (with YITH WooCommerce Multi Vendor)

= 1.6.24 - Released on 27 June 2021 =

* New: support for WordPress 5.8
* New: support for WooCommerce 5.5
* Update: YITH plugin framework

= 1.6.23 - Released on 21 June 2021 =

* Update: YITH plugin framework
* Update: integration with YITH Live Chat
* Fix: wrong user author in orders note
* Fix: sanitized issue during order saving
* Fix: automatically set as completed when the order that is set as picked up doesn't work

= 1.6.22 - Released on 10 June 2021 =
